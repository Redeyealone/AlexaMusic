...
async def alive(client, message: Message):
    await message.reply_photo(
        photo=f"https://te.legra.ph/file/e097fd5d24af5ae875c69.jpg",
        caption=f"""๏ Tʜɪs Is ˹ 𝙏𝘼𝙔𝙉 ✘ Mυѕι¢ ˼ ♪ !
➻ A Fᴀsᴛ & Pᴏᴡᴇʀғᴜʟ Tᴇʟᴇɢʀᴀᴍ Mᴜsɪᴄ Pʟᴀʏᴇʀ Bᴏᴛ Wɪᴛʜ Sᴏᴍᴇ Aᴡᴇsᴏᴍᴇ Fᴇᴀᴛᴜʀᴇs.
...
🎄 A  Pᴀʀᴛ  Oғ @LEGENDSxNETWORK""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🌼 ᴀʟᴇxᴀ ᴄʜᴀᴛ 💮", url=f"https://t.me/LEGENDSxGROUP")]]
        ),
    )
