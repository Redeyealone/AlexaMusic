...
OWNER_ID = list(map(int, getenv("OWNER_ID", "7162652056").split()))
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/LEGENDSxGROUP")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://te.legra.ph/file/e097fd5d24af5ae875c69.jpg"
)
